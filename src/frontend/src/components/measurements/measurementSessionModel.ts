import type { CreateMeasurementInput } from "../../services/measurementService";
...
export const CORE_REVIEW_FIELDS: Array<{ field: SessionField; stepIndex: number }> = [
  { field: "neck", stepIndex: 0 }, { field: "chest", stepIndex: 1 }, { field: "waist", stepIndex: 2 },
  { field: "abdomen", stepIndex: 3 }, { field: "hips", stepIndex: 4 },
];

export const PAIRED_REVIEW_FIELDS: Array<{ title: string; left: SessionField; right: SessionField; stepIndex: number }> = [
